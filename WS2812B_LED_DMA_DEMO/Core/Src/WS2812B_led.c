...
/**
  * @brief  set the correct values for the red green blue colors for a specific number of leds according to the ws2812b datasheet and then sends daat through pwm pin
  */
